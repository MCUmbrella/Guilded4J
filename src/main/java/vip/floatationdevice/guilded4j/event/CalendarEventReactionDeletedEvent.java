...
/**
 * Event fired when a reaction emote is removed from a calendar event.<br>
 * <a href="https://www.guilded.gg/docs/api/websockets/CalendarEventReactionDeleted" target=_blank>https://www.guilded.gg/docs/api/websockets/CalendarEventReactionDeleted</a>
 */
public class CalendarEventReactionDeletedEvent extends GuildedEvent
{
    private final String channelId, messageId, createdBy;
    private final Emote emote;
    private final int calendarEventId;

    public CalendarEventReactionDeletedEvent(Object source, String json)
    {
        super(source, json);
