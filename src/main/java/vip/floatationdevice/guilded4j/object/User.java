...
public class User
{
    ...
    public User setRealName(String name){this.name=name;return this;}
    public User setNickname(String nickname){this.nickname=nickname;return this;}
    public User setEmail(String email){this.email=email;return this;}
    public User setAvatarURL(String avatarURL){this.avatarURL=avatarURL;return this;}
    public User setRoleIds(int[] roleIds){this.roleIds=roleIds;return this;}
    public User setSocialLinks(HashMap<String, HashMap<String, String>> socialLinks){this.socialLinks=socialLinks;return this;}
    public User setBotId(String botId){this.botId=botId;return this;}
    public User setWebhookId(String webhookId){this.webhookId=webhookId;return this;}
