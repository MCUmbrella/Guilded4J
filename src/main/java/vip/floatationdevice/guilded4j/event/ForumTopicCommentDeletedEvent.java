...
/**
 * Event fired when a forum comment is deleted.<br>
 * <a href="https://www.guilded.gg/docs/api/websockets/ForumTopicCommentDeleted" target=_blank>https://www.guilded.gg/docs/api/websockets/ForumTopicCommentDeleted</a>
 */
public class ForumTopicCommentDeletedEvent extends GuildedEvent
{
    private final ForumTopicComment forumTopicComment;

    public ForumTopicCommentDeletedEvent(Object source, String json)
    {
        super(source, json);
